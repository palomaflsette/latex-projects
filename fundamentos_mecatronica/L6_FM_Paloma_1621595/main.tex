...
Trataremos da simulação de um sistema mecânico do servomotor ...., cujo datasheet é apresentado na página seguinte.\\

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\includepdf[pages={1}, pagecommand={\section{Anexo}}, 
    scale=0.9, 
    offset=0mm -10mm, 
    pagecommand={\thispagestyle{plain}},
    clip, 
    trim=10mm 10mm 10mm 10mm,
    center]{DATASHEET_22V28_48_p76.pdf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
